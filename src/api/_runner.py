...
from core.debugger import GdbMIController, DebugStopEvent, stop_event_is_terminal
from core.dwarf import (
    get_function_index,
    FunctionIndex,
...
def _persist_story_annotations(test: Test) -> None:
    ...
    from runner.makefile import save_story_annotations
...
async def _emit_skipped_standalone_exprs(
    ...
    from core.story import _is_standalone_expression_line
